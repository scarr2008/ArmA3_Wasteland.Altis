...
_resupplyThread = _vehicle spawn
{
	...
	_checkAbortConditions =
	{
		...
		if ({alive _x} count (_vehicle nearEntities [["O_Heli_Transport_04_ammo_F", "I_Truck_02_ammo_F", "O_Truck_03_ammo_F", "B_Truck_01_ammo_F","O_Truck_03_device_F"], RESUPPLY_TRUCK_DISTANCE]) == 0) then
		{
